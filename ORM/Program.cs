...
namespace ORM
{
    class Program
    {
        ...
        private static void ConnexionMySQL()
        {
            ...
            BDD mysql = new BDD();
            //mysql.InsertStatement(MySqlProvider, MySqlConnection, insertquery);
            //mysql.UpdateStatement(MySqlProvider, MySqlConnection, updatequery);
            mysql.DeleteStatement(MySqlProvider, MySqlConnection, deletequery);
            mysql.SelectStatement(MySqlProvider, MySqlConnection, selectquery);
        }
